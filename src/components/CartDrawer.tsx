...
export const CartDrawer: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (isOpen) {
      ...
      // При закрытии корзины НЕ делаем ничего с title
      if (wasOpenRef.current) {
        // ОДИН лог при закрытии
        console.log('🛒 [CartDrawer] Корзина закрыта');
        
        // НЕ вызываем trackPageView() - пусть AnalyticsInit отслеживает изменения route
        // Если пользователь закрыл корзину БЕЗ навигации - ничего не отправляем
      }
