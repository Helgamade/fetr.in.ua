-- Migration 009 v2: Add Authentication Tables Only
-- This version skips ALTER TABLE commands and creates only new tables
...
-- Add settings for admin IP whitelist (if not exist)
