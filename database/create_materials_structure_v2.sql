-- Создание правильной структуры таблиц для материалов (версия 2 - без внешних ключей)
-- Дата: 2025-01-14
...
-- Шаг 3: Создание таблицы product_materials БЕЗ внешних ключей
-- Внешние ключи можно добавить позже, если нужно
